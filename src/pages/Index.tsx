...
const topRestaurants: Restaurant[] = [
  { id: 1, name: 'Додо Пицца', cuisine: 'Пицца', rating: 4.9, address: 'ул. Ленина, 45', image: '/img/e123155b-f983-41c6-ac67-bd42e75b21c1.jpg', reviews: 1250 },
  { id: 2, name: 'Тануки', cuisine: 'Японская', rating: 4.8, address: 'пр. Мира, 12', image: '/img/ccefbed8-6cc7-4460-9eec-d5be8c01fbdc.jpg', reviews: 980 },
  { id: 3, name: 'Папа Джонс', cuisine: 'Пицца', rating: 4.7, address: 'ул. Советская, 78', image: '/img/e123155b-f983-41c6-ac67-bd42e75b21c1.jpg', reviews: 856 },
  { id: 4, name: 'Якитория', cuisine: 'Японская', rating: 4.8, address: 'ул. Гагарина, 23', image: '/img/ccefbed8-6cc7-4460-9eec-d5be8c01fbdc.jpg', reviews: 742 },
  { id: 5, name: 'Il Патио', cuisine: 'Итальянская', rating: 4.6, address: 'пр. Победы, 90', image: '/img/e123155b-f983-41c6-ac67-bd42e75b21c1.jpg', reviews: 623 },
  { id: 6, name: 'Суши Wok', cuisine: 'Паназиатская', rating: 4.5, address: 'ул. Пушкина, 34', image: '/img/ccefbed8-6cc7-4460-9eec-d5be8c01fbdc.jpg', reviews: 589 },
  { id: 7, name: 'Dominos', cuisine: 'Пицца', rating: 4.5, address: 'ул. Кирова, 56', image: '/img/e123155b-f983-41c6-ac67-bd42e75b21c1.jpg', reviews: 512 },
  { id: 8, name: 'Планета Суши', cuisine: 'Японская', rating: 4.4, address: 'пр. Ленина, 102', image: '/img/ccefbed8-6cc7-4460-9eec-d5be8c01fbdc.jpg', reviews: 478 },
  { id: 9, name: 'Pizza Hut', cuisine: 'Пицца', rating: 4.3, address: 'ул. Маркса, 67', image: '/img/e123155b-f983-41c6-ac67-bd42e75b21c1.jpg', reviews: 401 },
  { id: 10, name: 'Евразия', cuisine: 'Паназиатская', rating: 4.2, address: 'ул. Чехова, 89', image: '/img/ccefbed8-6cc7-4460-9eec-d5be8c01fbdc.jpg', reviews: 356 },
];
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-8">
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          <TabsList className="grid w-full grid-cols-4 mb-8 bg-white h-auto p-2 rounded-2xl shadow-sm">
